...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png', 430, 79, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 178, 280, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 180, 230, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 380, 450, 30, 15, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 98, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 126, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 230, 382, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 167, 80, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 139, 80, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 470, 470, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 470, 440, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 495, 410, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 761, 190, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 320, 485, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 360, 245, 30, 30, 1),
    ...
    new Obstaculo('imagenes/bache.png', 840, 100, 30, 30, 1)
  ],
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 70, 135, 10, 10, 2, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}),
    new ZombieCaminante('imagenes/zombie2.png', 90, 100, 10, 10, 2, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}),
    new ZombieCaminante('imagenes/zombie3.png', 90, 350, 10, 10, 2, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}),
    new ZombieCaminante('imagenes/zombie4.png', 75, 250, 10, 10, 2, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}),
    new ZombieCaminante('imagenes/zombie1.png', 60, 455, 10, 10, 2, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}),

    new ZombieConductor('imagenes/tren_horizontal.png', 644, 322, 90, 30, 6, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}, 'horizontal'),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 7, {desdeX: 20, hastaX: 941, desdeY: -20, hastaY: 557}, 'vertical'),
    new ZombieConductor('imagenes/tren_vertical.png', 675, 0, 30, 90, 6, {desdeX: 20, hastaX: 941, desdeY: -20, hastaY: 557}, 'vertical')
  ]
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarImagen('imagenes/finish.png', 760, 530, 128, 30);
...
Juego.calcularAtaques = function() {
  this.enemigos.forEach(function(enemigo) {
    ...
    //}
      ...
      COMPLETAR */
      Enemigo.prototype.dejarDeAtacar(this.jugador);
